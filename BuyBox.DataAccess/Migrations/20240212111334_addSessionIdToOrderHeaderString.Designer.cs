...
namespace BuyBox.DataAccess.Migrations
{
    ...
    [Migration("20240212111334_addSessionIdToOrderHeaderString")]
    partial class addSessionIdToOrderHeaderString
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuyBox.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BuyBox.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BuyBox.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BuyBox.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BuyBox.DataAccess.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BuyBox.Models.OrderDetail", b =>
                {
                    b.HasOne("BuyBox.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BuyBox.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("BuyBox.Models.OrderHeader", b =>
                {
                    b.HasOne("BuyBox.DataAccess.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BuyBox.Models.Product", b =>
                {
                    b.HasOne("BuyBox.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("BuyBox.DataAccess.ApplicationUser", b =>
                {
                    b.HasOne("BuyBox.Models.Company", "Company")
                        .WithMany()
